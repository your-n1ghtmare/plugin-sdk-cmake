...
using refs_t = RefList<0x518BC1,100,0,0x5189E0,1, 0x518DF1,110,0,0x518C10,1, 0x518D81,120,0,0x518BA0,1>;
using def_t = void();
...
// total references count: 10en (1), 11en (1), steam (1)
using refs_t = RefList<0x518D41,100,0,0x518D40,1, 0x518F71,110,0,0x518F70,1, 0x518F01,120,0,0x518F00,1>;
using def_t = void();
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Cdecl;
using args_t = ArgPick<ArgTypes<>>;
...
// total references count: 10en (1), 11en (1), steam (1)
using refs_t = RefList<0x518DC0,100,0,0x518DC0,1, 0x518FF0,110,0,0x518FF0,1, 0x518F80,120,0,0x518F80,1>;
using def_t = void();
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Cdecl;
using args_t = ArgPick<ArgTypes<>>;
...
using refs_t = RefList<0x47472A,100,0,0x474350,1, 0x4747CA,100,0,0x474350,2, 0x518D1F,100,0,0x518BF0,1, 0x47472A,110,0,0x474350,1, 0x4747CA,110,0,0x474350,2, 0x518F4F,110,0,0x518E20,1, 0x47472A,120,0,0x474350,1, 0x4747CA,120,0,0x474350,2, 0x518EDF,120,0,0x518DB0,1>;
